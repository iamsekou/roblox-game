...
Last updated: 2026-09-25: M1 click combo + trade clash built on branch `m1-combo` (section 2). Before that, 2026-09-24: all work committed. The owner declared the game's **first drop ready and complete**
...
- Unit tests (`TestRunner`, in Play on the Server): **136/136** [Verified, 2026-09-25; 10 MeleeRules tests added]. Specs: CodeBook 11, MatchCore 28,
